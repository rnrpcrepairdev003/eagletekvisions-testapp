    ...
    <>
      ...
      <section className="hero-dark hero-grid relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 relative">
          <Link href="/articles" className="inline-flex items-center gap-2 text-[#aaaaaa] hover:text-white text-sm mb-8 transition-colors">
            ← Back to Articles
          </Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedArticles.map((a) => (
                <Link key={a.slug} href={`/articles/${a.slug}`} className="group bg-white border border-[#e0e0e0] rounded-2xl p-7 card-hover shadow-sm">
                  ...
                  <span className="text-xs text-[#e87c5a] font-semibold uppercase tracking-wider mb-2 block">{a.badge}</span>
